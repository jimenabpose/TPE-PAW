...
public class Version extends PersistentAttributes {
	...
	public Version(String name, String description, Date releaseDate, Project project){
		this.setName(name);
		this.setDescription(description);
		this.setReleaseDate(releaseDate);
		this.setState(VersionState.OPEN);
...
//	}
	...
	public HashMap<String, List<Issue>> getIssuesByPriority(){
		HashMap<String, List<Issue>> issuesByPriority = new HashMap<String, List<Issue>>();
		for(Priority priority : Priority.values()) {
			issuesByPriority.put(priority.toString(), new ArrayList<Issue>());
		}
		
		for(Issue issue : this.getIssues()) {
			issuesByPriority.get(issue.getPriority().toString()).add(issue);
		}
